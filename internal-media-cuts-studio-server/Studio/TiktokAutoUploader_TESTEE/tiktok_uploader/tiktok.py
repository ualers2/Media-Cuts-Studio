...
# Local Code...
def upload_video(WEBHOOK_URL, api_key, session_user_cookie, video, title, schedule_time=0, allow_comment=1, allow_duet=0, allow_stitch=0, visibility_type=0, brand_organic_type=0, branded_content_type=0, ai_label=0, proxy=None, webhook=True):
	"""
