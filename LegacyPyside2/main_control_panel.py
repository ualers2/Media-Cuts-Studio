...
class LoadingScreen(QMainWindow):
    def __init__(self):
        ...
        # PRESERVE: json_style_Splash start
        json_style_Splash = os.path.abspath(os.path.join("MediaCutsStudio", "Versions", "Version_2", "CoreApp", "JsonStyle", "style_Splash.json"))
        loadJsonStyle(self=self, ui=self.ui, jsonFiles = {json_style_Splash})
        # PRESERVE: json_style_Splash end
...
class Main_Control_Panel(QMainWindow):
    ...
    def __init__(self):
        ...
        # PRESERVE: json_style_control_panel start
        json_style_control_panel = os.path.abspath(os.path.join("MediaCutsStudio", "Versions", "Version_2", "CoreApp", "JsonStyle", "style_control_panel.json"))
        loadJsonStyle(self=self, ui=self.ui, jsonFiles = {json_style_control_panel})
        # PRESERVE: json_style_control_panel end
